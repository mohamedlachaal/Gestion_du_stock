...
include("nav.php");
    ...
    if(isset($_POST["nom"]))
    {
        ...
        if($errnom==""&&$errprenom==""&&$errcin==""&&$errtel==""&&$erremail==""&&$errpas=="")
        {
            ...
            die();*/
            require("db.php");
            $query="insert into fournisseur value(NULL,:nom,:prenom,:cin,:email,:telephone,:societe,:password)";
            $stmt=$conn->prepare($query);
            $stmt->execute(array(":nom"=>$nom,":prenom"=>$prenom,":cin"=>$cin,":email"=>$email,":telephone"=>$tel,"societe"=>$soc,":password"=>$pass));
...
<div id="container">
            ...
            <form action="#" method="POST">
                ...
                <input type="text" placeholder="Entrer le nom du societe " name="soc" required>
